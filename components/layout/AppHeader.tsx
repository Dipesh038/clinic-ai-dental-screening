...
export function AppHeader({ user }: AppHeaderProps) {
  ...
  return (
    <header className="flex min-h-16 flex-wrap items-center justify-between gap-x-4 gap-y-2 border-b border-border bg-background dark:bg-[#272727] px-4 py-2 sm:px-6">
